...
public class CardDatabase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        cardList.Add(new Card(11, "Poison Spray", 1, 0, 0, 0, "Apply 4 Poison to All Enemies", "Skill", Resources.Load<Sprite>("1"), "All", 0, 6, 0, 4, false, false, Resources.Load<AudioClip>("Sounds/poison_damage")));
        ...
        cardList.Add(new Card(13, "Poisoned Scrape", 1, 4, 1, 0, "Deal {0} Damage and apply 4 Poison", "Attack", Resources.Load<Sprite>("1"), "Single", 0, 6, 0, 4, false, false, Resources.Load<AudioClip>("Sounds/poison_damage")));
