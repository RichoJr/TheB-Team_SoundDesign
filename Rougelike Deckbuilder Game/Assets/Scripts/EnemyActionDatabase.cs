...
public class EnemyActionDatabase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        attacklist.Add(new EnemyAction(2, "Slime Sling", 3, 0, 1, 0, 0, 3, 1, Resources.Load<Sprite>("Circle"), Resources.Load<AudioClip>("Sounds/Fart")));
        ...
        attacklist.Add(new EnemyAction(5, "Sleaze Ball", 7, 0, 1, 0, 0, 6, 2, Resources.Load<Sprite>("Circle"), Resources.Load<AudioClip>("Sounds/Fart")));
        ...
        attacklist.Add(new EnemyAction(11, "Envenom", 0, 0, 1, 4, 3, 14, 1, Resources.Load<Sprite>("Circle"), Resources.Load<AudioClip>("Sounds/Fart")));
