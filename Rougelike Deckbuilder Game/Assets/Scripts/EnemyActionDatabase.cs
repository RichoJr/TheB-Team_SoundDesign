...
public class EnemyActionDatabase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        attacklist.Add(new EnemyAction(1, "Bash", 5, 0, 1, 0, 0, 0, 0, Resources.Load<Sprite>("Circle"), Resources.Load<AudioClip>("Sounds/bash")));
        ...
        attacklist.Add(new EnemyAction(7, "Repeated Stabbing", 1, 0, 4, 0, 0, 0, 0, Resources.Load<Sprite>("Circle"), Resources.Load<AudioClip>("Sounds/enemy_stab")));
        ...
        attacklist.Add(new EnemyAction(9, "Fang Strike", 3, 0, 2, 0, 0, 6, 3, Resources.Load<Sprite>("Circle"), Resources.Load<AudioClip>("Sounds/enemy_stab")));
        ...
        attacklist.Add(new EnemyAction(12, "Corrosive Bite", 9, 0, 1, 0, 0, 3, 1, Resources.Load<Sprite>("Circle"), Resources.Load<AudioClip>("Sounds/enemy_stab")));
